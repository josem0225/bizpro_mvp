    ...
    return (
        <main className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-[var(--navy-deep)]">
            ...
            <div className="hidden lg:block relative bg-[var(--navy-brand)] overflow-hidden">
                {/* Abstract Background */}
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,rgba(59,130,246,0.3)_0%,var(--navy-deep)_80%)]"></div>
                ...
                <div className="relative z-10 w-full h-full flex flex-col justify-center px-16 text-white">
                    <div className="max-w-md">
                        <div className="w-12 h-12 bg-[var(--blue-electric)] rounded-xl flex items-center justify-center text-xl font-bold mb-8">
                            B
                        </div>
                        <h2 className="text-4xl font-bold mb-6">Coordina tu negocio sin sorpresas.</h2>
                        ...
                        <div className="mt-12 flex gap-4">
                            <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10 flex-1">
                                ...
                                <div className="text-xs text-gray-400">En Español</div>
                            </div>
                            <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10 flex-1">
                                <div className="text-2xl font-bold mb-1">$0</div>
                                <div className="text-xs text-gray-400">Costos Ocultos</div>
                            </div>
                        </div>
                    </div>
                </div>
